			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - David de Fitero</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - David de Fitero</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://david.defitero.com/sitemap_index.xml">&#8592; Índice del mapa del sitio</a>							</p>
